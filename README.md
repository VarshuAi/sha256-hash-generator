...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/sha256-hash-generator.git
   cd sha256-hash-generator
   ```
...
[![Repo](https://img.shields.io/badge/sha256-hash-generator-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/sha256-hash-generator)
